...
public class CompileDetailsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private int length;
    //修改目标体重
    private EditText change_wantweight;
    private  int want_weight;
    ...
    protected void initValues() {
        ...
        want_weight = SaveKeyValues.getIntValues("plan_want_weight_values",0);
      }
    ...
    protected void initViews() {
        ...
        change_wantweight = (EditText) findViewById(R.id.change_wantweight);
    }
    ...
    protected void setViewsFunction() {
        ...
        change_wantweight.setHint(String.valueOf(want_weight));
        change_wantweight.setHintTextColor(getResources().getColor(R.color.btn_gray));
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.change_ok://保存退出
                ...
                if (!"".equals(change_wantweight.getText().toString())){
                    SaveKeyValues.putIntValues("plan_want_weight_values", Integer.parseInt(change_wantweight.getText().toString().trim())); //保存目标体重
                }
                finish();
                break;
            default:
   ...
   protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    private void  hideKeyBoard(){
        ((InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(CompileDetailsActivity.this.getCurrentFocus().getWindowToken(),
